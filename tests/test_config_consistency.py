...
@pytest.mark.parametrize("func,param_name,config_name", [
    ...
    (analysis_a.permutation_test_for_segment, "p_threshold", "ANALYSIS_A_P_VALUE_THRESHOLD"),
    (analysis_a.permutation_test_for_segment, "check_every", "SEQUENTIAL_PERMUTATION_CHECK_EVERY"),
